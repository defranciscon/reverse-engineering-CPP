...
.L5:
	...
	ret
	.seh_endproc
	.section	.text$_ZNSt8ios_base5widthEx,"x"
	.linkonce discard
	.align 2
	.globl	_ZNSt8ios_base5widthEx
	.def	_ZNSt8ios_base5widthEx;	.scl	2;	.type	32;	.endef
	.seh_proc	_ZNSt8ios_base5widthEx
_ZNSt8ios_base5widthEx:
.LFB1465:
	pushq	%rbp
	.seh_pushreg	%rbp
	movq	%rsp, %rbp
...
password:
	.quad	.LC0
.lcomm _ZL5name1,32,32
.lcomm _ZL5name2,32,32
.lcomm _ZL5name3,32,32
.lcomm _ZL5name4,32,32
.lcomm _ZL5name5,32,32
	.globl	num1
	.align 4
num1:
	.long	1
...
choice:
	...
	.align 8
.LC1:
	.ascii "Create by: Nicolas W. DeFrancisco.\12\0"
	.align 8
.LC2:
	.ascii "Hello! Welcome to our Investment Company\0"
.LC3:
	.ascii "What would you like to do?\0"
	.align 8
.LC4:
	.ascii "DISPLAY the client list (enter 1)\0"
	.align 8
.LC5:
	.ascii "CHANGE a client's choice (enter 2)\0"
.LC6:
	.ascii "Exit the program.. (enter 3)\0"
.LC7:
	.ascii "You chose \0"
	.text
	.globl	main
...
.LC9:
	.ascii "Enter Password:\12\0"
	.align 8
.LC10:
	.ascii "Invalid Password. Please try again.\0"
	.text
	.globl	_Z25CheckUserPermissionAccessv
	.def	_Z25CheckUserPermissionAccessv;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z25CheckUserPermissionAccessv
...
.LLSDACSB1850:
	.uleb128 .LEHB0-.LFB1850
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB1850
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L24-.LFB1850
	.uleb128 0
	.uleb128 .LEHB2-.LFB1850
	.uleb128 .LEHE2-.LEHB2
	.uleb128 0
	.uleb128 0
.LLSDACSE1850:
	...
	.align 8
.LC11:
	.ascii "Enter the number of the client that you wish to change\0"
	.align 8
.LC12:
	.ascii "Please enter the client's new service choice (1 = Brokerage, 2 = Retirement)\0"
	.text
	.globl	_Z20ChangeCustomerChoicev
	.def	_Z20ChangeCustomerChoicev;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z20ChangeCustomerChoicev
...
.L33:
	...
	.section .rdata,"dr"
.LC13:
	.ascii "  Client's Name    \0"
	.align 8
.LC14:
	.ascii "Service Selected (1 = Brokerage, 2 = Retirement)\0"
.LC15:
	.ascii ". \0"
.LC16:
	.ascii " selected option \0"
	.text
	.globl	_Z11DisplayInfov
	.def	_Z11DisplayInfov;	.scl	2;	.type	32;	.endef
	.seh_proc	_Z11DisplayInfov
_Z11DisplayInfov:
.LFB1853:
	pushq	%rbp
	.seh_pushreg	%rbp
...
.LLSDACSE2119:
	...
	.linkonce discard
	.seh_endproc
	.section	.text$_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_PS3_,"x"
	.linkonce discard
...
.L54:
	...
	movq	%rcx, %r8
	movq	%rax, %rcx
	call	_ZSt17__istream_extractRSiPcx
.L53:
	movq	16(%rbp), %rax
	addq	$48, %rsp
	popq	%rbp
...
.LC19:
	.ascii "Sarah Davis\0"
.LC20:
	.ascii "Amy Friendly\0"
.LC21:
	.ascii "Johnny Smith\0"
.LC22:
	.ascii "Carol Spears\0"
	.text
...
.LEHB12:
	...
	leaq	32(%r12), %rax
	subq	$1, %rbx
	leaq	_ZL5name5(%rip), %rdx
	movq	%rax, %rcx
	call	_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1ERKS4_
.LEHE12:
	leaq	8(%rdi), %rax
	movq	%rax, _Z5namesB5cxx11(%rip)
	movl	$20, %ecx
.LEHB13:
	call	_Znay
	movq	%rax, %rdx
...
.LLSDACSE2396:
	.text
	.seh_endproc
	.def	_GLOBAL__sub_I_password;	.scl	3;	.type	32;	.endef
	.seh_proc	_GLOBAL__sub_I_password
_GLOBAL__sub_I_password:
.LFB2403:
	pushq	%rbp
	.seh_pushreg	%rbp
	movq	%rsp, %rbp
	...
	.def	_ZSt17__istream_extractRSiPcx;	.scl	2;	.type	32;	.endef
